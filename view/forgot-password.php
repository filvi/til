                ...
                <div class="col-md-6 d-md-flex align-items-center justify-content-center">
                    <div class="whitish py-5 px-5 mycard rounded">
                        ...
                        <form method="post">
                            ...
                            <div class="form-group d-xl-flex align-items-center align-content-center align-self-center"><button class="btn login py-2 px-3 se pt-3 rounded font-weight-bold letter-spacing-1 fs-2 mx-auto btn-fill-red mt-2" type="submit">Send</button></div>
                        </form>
