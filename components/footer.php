    <!-- Start: Footer -->
    <footer class="footer-dark position-absolute b-0 w-100">
        <div class="container">
            <div class="row">
                <!-- Start: Legal notes -->
            ...
            <p class="copyright mt-3" style="font-size: 30px;">Developed with ❤ by <img src="/assets/img/fv_white.png?h=10b05bf46b905e6c50ac5e05d184bad5" style="max-width: 44px;">, illustration by Giulia Maruzzelli © 2021</p><!-- End: Copyright -->
        </div>
    </footer><!-- End: Footer -->
